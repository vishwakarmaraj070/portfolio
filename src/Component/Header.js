        ...
        <header>
                  ...
                  <li
                    onClick={e => {
                      this.setState({
                        isHome: false,
                        title: "Talks",
                        titleContent: "Free to Talk with me for Hire"
                      });
                    }}
                    className="nav-item mr-lg-3"
                  >
                  ...
                  <li
                    onClick={e => {
                      this.setState({
                        isHome: false,
                        title: "Blog",
                        titleContent: "Here is My Blog related to project"
                      });
                    }}
                    className="nav-item mr-lg-3"
                  >
                  ...
                  <li
                    onClick={e => {
                      this.setState({
                        isHome: false,
                        title: "Resume",
                        titleContent: "This is my Resume for first Presentation"
                      });
                    }}
                    className="nav-item mr-lg-3"
                  >
                  ...
                  <li
                    onClick={e => {
                      this.setState({
                        ...
                        title: "Contact",
                        titleContent:
                          "Contact me any time Hire for your Project"
                      });
                    }}
                    className="nav-item mr-lg-3"
                  >
          ...
          {window.location.href.length !==
            window.location.href.lastIndexOf("/") + 1 ? (
              <HalfBanner
                title={window.location.href.substr(
                  window.location.href.lastIndexOf("/") + 1
                )}
